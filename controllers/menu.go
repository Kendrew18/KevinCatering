...
func InputMenu(c echo.Context) error {
	...
	result, err := models.Input_Menu(id_catering, nama_menu, harga_menu, tanggal_menu, jam_pengiriman_awal, jam_pengiriman_akhir, status)
...
func ReadMenu(c echo.Context) error {
	...
	result, err := models.Read_Menu(id_catering, tanggal_menu)
...
func EditMenu(c echo.Context) error {
	...
	result, err := models.Edit_Menu(id_catering, id_menu, nama_menu, harga_menu, tanggal_menu, jam_pengiriman_awal, jam_pengiriman_akhir)
...
func DeleteMenu(c echo.Context) error {
	...
	result, err := models.Delete_Menu(id_catering, id_menu, tanggal_menu)
